...
//		die;
	...
	function compile_css() {
		...
		// Important! For mobile theme, td_global::$viewport_settings is not set, because the shortcodes usually comes with specific css. But there are shorcodes (like those of tds_locker plugin) which need it.
		// For those shorcodes we set a media viewport with 'all'. but the media query is for phones (@media (max-width: 767px))
