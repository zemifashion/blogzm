...
/**
 * Add Custom tab content post.
 */
wp_enqueue_script('tab-content-post', get_template_directory_uri() . '/includes/js/tab-content-post.js',
    array('jquery'), '1.0', true
);

wp_enqueue_style('tab-content-css', get_template_directory_uri() . '/includes/css/tab-content-css.css' );